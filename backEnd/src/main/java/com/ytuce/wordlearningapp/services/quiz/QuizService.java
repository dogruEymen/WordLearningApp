...
public class QuizService {
    ...
    private QuestionDto mapQuestionToDto(Question q) {
        ...
        // Doğru cevapların writing değerlerini ekle
        List<String> correctWritings = q.getCorrectAnswers().stream()
                .flatMap(answer -> answer.getAnswerWords().stream())
                .map(Word::getWriting)
                .distinct()
                .toList();
        dto.setCorrectAnswerWritings(correctWritings);
        
        return dto;
    }

    private OptionDto mapOptionToDto(WordWithMeaning o) {
        return OptionDto.builder()
                .writing(o.getWord() != null ? o.getWord().getWriting() : null)
                .meaningTr(o.getMeaning() != null ? o.getMeaning().getDescriptionTr() : null)
                .meaningEn(o.getMeaning() != null ? o.getMeaning().getDescriptionEn() : null)
                .build();
    }
}